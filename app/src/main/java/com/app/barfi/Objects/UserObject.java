...
public class UserObject implements Serializable {
    ...
    public void parseObject(DataSnapshot dataSnapshot){
        ...
        if(dataSnapshot.child("filters").child("ageMin").getValue()!=null)
            ageMin = dataSnapshot.child("filters").child("ageMin").getValue().toString();
        if(dataSnapshot.child("filters").child("ageMax").getValue()!=null)
            ageMax = dataSnapshot.child("filters").child("ageMax").getValue().toString();
        if(dataSnapshot.child("filters").child("interest").getValue()!=null)
            interest = dataSnapshot.child("filters").child("interest").getValue().toString();
        if(dataSnapshot.child("filters").child("search_distance").getValue()!=null)
            searchDistance = Float.parseFloat(dataSnapshot.child("filters").child("search_distance").getValue().toString());
